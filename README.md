...
#### Session 1  _Introduction to PKS & K8s Primitives_

#### Session 2  _RBAC for Different Personas_
...
#### Session 3 _Application Access using k8s Services and Ingress Controllers_
  - [Lab 3 - Deploying Apps using k8s Services, Creating Nginx Ingress Controller](session_03/lab_03.adoc)
 
 #### Session 4 _PKS HA and Health Monitoring_
